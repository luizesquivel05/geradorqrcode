...
> Em nosso programa iremos gerar QR Code com conteúdos escolhidos pelo usuário.
...
## 🚀 Instalando geradorQRCODE:

Para instalar o geradorQRCODE, siga estas etapas:
...
## ☕ Usando geradorQRCODE:

Para usar geradorQRCODE, siga estas etapas:
...
## 📫 Contribuindo para geradorQRCODE
Para contribuir com geradorQRCODE, siga estas etapas:

1. Bifurque (clone) este repositório.
2. Crie um branch: `git checkout -b <nome_branch>`.
3. Faça suas alterações e confirme-as: `git commit -m '<mensagem_commit>'`
4. Envie para o branch original: `git push origin geradorQRCODE / <local>`
